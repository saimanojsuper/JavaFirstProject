...
public class Fig_to_wordss {

	public static void main(String[] args) {
		fig_to_words("9923".toCharArray());
		fig_to_words("132".toCharArray());
		fig_to_words("8".toCharArray());
		fig_to_words("8989".toCharArray());

	}

	static void fig_to_words(char[] num) {
		...
		String[] tens_power = new String[] { "hundred", "thousand", "ten thousand" };
		...
		if (len == 1) {
			System.out.println(single_digits[num[0] - '0'] + " only.");
			return;
		}
		...
		while (x < num.length) {
			...
			if (len >= 3) {
				...
				if (num[x] - '0' != 0) {
					...
					if (k == 0)
						System.out.print(tens_power[len - 3] + " and ");
			...
			/* Code path for last 2 digits */
				 ...
				 */
					...
					++x;
					if (num[x] - '0' != 0)
						System.out.println(single_digits[num[x] - '0'] + " only.");
				}
			}
			++x;
		}
